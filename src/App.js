    ...
    //   }
      ...
      const searchJob = () => {
          ...
          //Should be the same code as findJobs but only when you click the Find Jobs button!
           // This function should filter jobs based on what you type on the input field!
        //How can you grab what you typed in the input field?
        console.log(document.getElementById("filter-jobs").value)
        
        if(document.getElementById("filter-jobs").value){
            // What does the filter function do?
            // What array should you be filtering?
            jobs.filter(job => {
                if(job.roleName.toLowerCase().includes(document.getElementById("filter-jobs").value) 
                    || job.type.toLowerCase().includes(document.getElementById("filter-jobs").value)
                    || job.company.toLowerCase().includes(document.getElementById("filter-jobs").value)
                    || job.requirements.content.toLowerCase().includes(document.getElementById("filter-jobs").value)) {
